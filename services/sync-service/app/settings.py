...
# Terraform injects the Redis IP into REDIS_HOST (or DB_HOST, based on mapping)
# We prioritize REDIS_HOST, but fallback to DB_HOST if that's where the IP is.
