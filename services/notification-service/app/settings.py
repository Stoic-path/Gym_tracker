...
# We use Postgres for storing notification logs/history
...
# --- Redis Configuration ---
# CRITICAL: Notification service relies heavily on Redis for Queues/Channels
